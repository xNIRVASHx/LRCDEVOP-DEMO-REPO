...
function Action()
{
	...
	lr.thinkTime(23);
	lr.startTransaction('ClickSpeakers');
	...
	lr.endTransaction('ClickSpeakers', lr.AUTO);

	lr.thinkTime(14);
	lr.startTransaction('ClickBose');
	...
	lr.endTransaction('ClickBose', lr.AUTO);

	lr.startTransaction('ClickHome');

	lr.endTransaction('ClickHome', lr.AUTO);
